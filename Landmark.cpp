...
Landmark::Landmark(int cost, std::string location, Resources *resources, int size, Citizen *owner, TaxAuthority *taxAuthority, std::string name) : Building(cost, location, resources, size, owner, taxAuthority){
    this->name = name;
}
